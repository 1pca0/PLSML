...
def main():
    ...
    if not os.path.exists(args.test_dir):
        os.makedirs(args.test_dir)
    net.load_state_dict(torch.load(r"D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2024_4_15semi_MCF+reliable_label0.5hr\epoch_30.0000-mean_sensiti287.6541-dice90.2580")[
                            'state_dict'])
