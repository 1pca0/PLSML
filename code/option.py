...
parser.add_argument('--lr', type=float, default=0.003, help='Initial learning rate [default: 0.001]')
#20
...
#80,192,304
parser.add_argument('--cubesize', default=[80,128,128], nargs="*", type=int, metavar='cube',
					help='cube size')
...
parser.add_argument('--stridet', default=[80,108,108], nargs="*", type=int, metavar='stride',
					help='split stride train')
# parser.add_argument('--stridet', default=[64,96,152], nargs="*", type=int, metavar='stride',
# 					help='split stride train')
#48,80,80
#[48,48,48][32,32,32]
parser.add_argument('--stridev', default=[64,64,64], nargs="*", type=int, metavar='stride',
...
#原来0
parser.add_argument('--gpu', default='0', type=str, metavar='mgpu',
					help='use multiple gpus')
