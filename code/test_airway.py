...
def main():
    ...
    save_dir = os.path.join(r'D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2023_3_24__semi_MCF+reliable_label', save_dir)
    print("savedir:", save_dir)

    marginv = [128,128,128]
    args.stridev = [108,108,108]
    ...
    net.load_state_dict(torch.load(r"D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2023_3_24__semi_MCF+reliable_label\epoch_26.0000-mean_sensiti289.5514-dice91.2674")[
                            'state_dict'])
    # model_resnet.load_state_dict(torch.load(r'D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2023_3_22_2_semi_MCF+reliable_label\epoch_28.0000-mean_sensiti285.0205-dice89.5546'
    #                                          )['state_dict'])
