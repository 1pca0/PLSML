...
def main():
    ...
    save_dir = os.path.join(r'D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2024_4_15semi_MCF+reliable_label0.5hr', save_dir)
    ...
    net.load_state_dict(torch.load(r"D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2024_4_15semi_MCF+reliable_label0.5hr\epoch_29.0000-mean_sensiti286.3282-dice90.3270")[
                            'state_dict'])
